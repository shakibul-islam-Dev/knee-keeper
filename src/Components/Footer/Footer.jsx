...
const Footer = () => {
  return (
    <footer className="w-full bg-[#1e3d33] text-white h-50 flex items-center px-6 md:px-12 fixed bottom-0 left-0 z-40 border-t border-white/10">
      <div className="max-w-7xl mx-auto w-full flex flex-col justify-center items-center gap-6">
        {/* Top Section: Branding & Slogan (Based on Image) */}
        <div className="text-center">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-2">
            KeenKeeper
          </h2>
          <p className="text-[10px] md:text-xs text-gray-300 max-w-md mx-auto opacity-80">
        ...
        <div className="w-full flex justify-between items-center text-[9px] md:text-[10px] text-gray-500 border-t border-white/5 pt-4 absolute bottom-4 px-6 md:px-12">
...
const SocialButton = ({ d }) => (
  <a
    href="#"
    className="w-8 h-8 bg-white rounded-full flex items-center justify-center hover:bg-gray-200 transition-all group"
  >
    <svg
